...
const generateRegisterFormValues = () => {
  return {
    firstName: {
      ...
      required: true,
      error: "",
      validateInput: (name) => (name.length > 3 ? null : "name should have at leats 3 character"),
    },
    lastName: {
      value: "",
      required: true,
      error: "",
      validateInput: (lastName) => (lastName.length > 3 ? null : "lastname should have at leats 1 character"),
    },
    email: {
      value: "",
      required: true,
    ...
    password: {
      ...
      required: true,
      error: "",
      validateInput: (password) => (password.length > 6 ? null : "email is not valid"),
    },
  };
};
